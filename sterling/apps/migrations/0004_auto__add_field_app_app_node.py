...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'App.app_node'
        db.add_column(u'apps_app', 'app_node',
                      self.gf('annoying.fields.AutoOneToOneField')(to=orm['fbNodes.AppNode'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'App.app_node'
        db.delete_column(u'apps_app', 'app_node_id')


    models = {
        u'apps.app': {
            'Meta': {'object_name': 'App'},
            'app_node': ('annoying.fields.AutoOneToOneField', [], {'to': u"orm['fbNodes.AppNode']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
