...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MobileApp.default_algorithm'
        db.add_column(u'apps_mobileapp', 'default_algorithm',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['suggestions.Algorithm'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MobileApp.default_algorithm'
        db.delete_column(u'apps_mobileapp', 'default_algorithm_id')
