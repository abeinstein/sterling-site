...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SuggestionList.presented_count'
        db.add_column(u'suggestions_suggestionlist', 'presented_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'AppUser.first_name'
        db.delete_column(u'suggestions_appuser', 'first_name')

        # Deleting field 'AppUser.last_name'
        db.delete_column(u'suggestions_appuser', 'last_name')

        # Adding field 'AppUser.name'
        db.add_column(u'suggestions_appuser', 'name',
        ...
        # Changing field 'AppUser.facebook_id'
        db.alter_column(u'suggestions_appuser', 'facebook_id', self.gf('django.db.models.fields.CharField')(max_length=50))
        # Adding field 'Suggestion.presented'
        db.add_column(u'suggestions_suggestion', 'presented',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Suggestion.first_presentation_date'
        db.add_column(u'suggestions_suggestion', 'first_presentation_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Suggestion.last_presentation_date'
        db.add_column(u'suggestions_suggestion', 'last_presentation_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Suggestion.invited_date'
        db.add_column(u'suggestions_suggestion', 'invited_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Suggestion.accepted_date'
        db.add_column(u'suggestions_suggestion', 'accepted_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'SuggestionList.presented_count'
        db.delete_column(u'suggestions_suggestionlist', 'presented_count')

        # Adding field 'AppUser.first_name'
        db.add_column(u'suggestions_appuser', 'first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AppUser.last_name'
        db.add_column(u'suggestions_appuser', 'last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'AppUser.name'
        db.delete_column(u'suggestions_appuser', 'name')
        ...
        # Changing field 'AppUser.facebook_id'
        db.alter_column(u'suggestions_appuser', 'facebook_id', self.gf('django.db.models.fields.PositiveIntegerField')())
        # Deleting field 'Suggestion.presented'
        db.delete_column(u'suggestions_suggestion', 'presented')

        # Deleting field 'Suggestion.first_presentation_date'
        db.delete_column(u'suggestions_suggestion', 'first_presentation_date')

        # Deleting field 'Suggestion.last_presentation_date'
        db.delete_column(u'suggestions_suggestion', 'last_presentation_date')

        # Deleting field 'Suggestion.invited_date'
        db.delete_column(u'suggestions_suggestion', 'invited_date')

        # Deleting field 'Suggestion.accepted_date'
        db.delete_column(u'suggestions_suggestion', 'accepted_date')
