...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Suggestion.invited'
        db.delete_column(u'suggestions_suggestion', 'invited')
        ...
        # Adding field 'Suggestion.times_presented'
        db.add_column(u'suggestions_suggestion', 'times_presented',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Suggestion.times_invited'
        db.add_column(u'suggestions_suggestion', 'times_invited',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Suggestion.last_invited_date'
        db.add_column(u'suggestions_suggestion', 'last_invited_date',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Suggestion.invited'
        db.add_column(u'suggestions_suggestion', 'invited',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        ...
        # Deleting field 'Suggestion.times_presented'
        db.delete_column(u'suggestions_suggestion', 'times_presented')

        # Deleting field 'Suggestion.times_invited'
        db.delete_column(u'suggestions_suggestion', 'times_invited')

        # Deleting field 'Suggestion.last_invited_date'
        db.delete_column(u'suggestions_suggestion', 'last_invited_date')
    ...
    models = {
        ...
        u'suggestions.suggestion': {
            'Meta': {'ordering': "['rank']", 'object_name': 'Suggestion'},
