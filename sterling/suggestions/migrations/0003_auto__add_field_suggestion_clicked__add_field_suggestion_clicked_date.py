...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Suggestion.clicked'
        db.add_column(u'suggestions_suggestion', 'clicked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Suggestion.clicked_date'
        db.add_column(u'suggestions_suggestion', 'clicked_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Suggestion.clicked'
        db.delete_column(u'suggestions_suggestion', 'clicked')

        # Deleting field 'Suggestion.clicked_date'
        db.delete_column(u'suggestions_suggestion', 'clicked_date')
    ...
    models = {
        ...
        u'suggestions.suggestion': {
            ...
            'clicked_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
