...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'AppUser', fields ['facebook_id']
        db.create_unique(u'suggestions_appuser', ['facebook_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'AppUser', fields ['facebook_id']
        db.delete_unique(u'suggestions_appuser', ['facebook_id'])
