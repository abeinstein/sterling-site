...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Suggestion.last_presented_date'
        db.add_column(u'suggestions_suggestion', 'last_presented_date',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Suggestion.last_presented_date'
        db.delete_column(u'suggestions_suggestion', 'last_presented_date')
